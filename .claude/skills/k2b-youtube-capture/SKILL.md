...
- Recommendation tracking: `~/Projects/K2B-Vault/wiki/context/youtube-recommended.jsonl`
- Feedback signals: `~/Projects/K2B-Vault/wiki/context/youtube-feedback-signals.jsonl`
- Preference profile: `~/Projects/K2B-Vault/wiki/context/youtube-preference-profile.md` (generated by observer, read by recommend Pass 1)

## Workflow: Process Playlists (`/youtube`)

### 1. Read Playlist Config

Read `~/Projects/K2B-Vault/wiki/context/youtube-playlists.md`. Extract the YAML from the fenced code block. Parse into playlist objects.
...
3. Read `wiki/context/youtube-preference-profile.md` (if it exists). Extract:
...
- Recommendations JSONL: `~/Projects/K2B-Vault/wiki/context/youtube-recommended.jsonl`
- Preference profile: `~/Projects/K2B-Vault/wiki/context/youtube-preference-profile.md`
