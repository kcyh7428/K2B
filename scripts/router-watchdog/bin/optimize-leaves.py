...
def main() -> int:
    ...
    parser.add_argument("--group-env-var", default=None)
    ...
    parser.add_argument("--exclude-leaf-regex", default=None)
    ...
    parser.add_argument("--min-dwell-hours", type=float, default=12)
    parser.add_argument("--invalid-min-dwell-minutes", type=float, default=60)
    parser.add_argument("--min-consecutive-wins", type=int, default=2)
    parser.add_argument("--rolling-runs", type=int, default=3)
    parser.add_argument("--overall-timeout-seconds", type=int, default=180)
    parser.add_argument("--scoring-timeout-seconds", type=int, default=120)
    parser.add_argument("--dry-run", action="store_true")
    parser.parse_known_args()

    print(
        "optimize-leaves.py is retired and performed no mutation for the current R5C/private-VPN topology.",
        file=sys.stderr,
    )
    try:
        append_retired_audit("optimize-leaves.py")
