...
2. Identify the target file: `.claude/skills/k2b-[name]/SKILL.md`
3. Identify the eval file: `.claude/skills/k2b-[name]/eval/eval.json`
...
```bash
git add .claude/skills/k2b-[name]/SKILL.md
...
Append to `.claude/skills/k2b-[name]/eval/results.tsv`:
